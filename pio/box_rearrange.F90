...
# 1080 "box_rearrange.F90.in"
  subroutine compute_counts(Iosystem, ioDesc, ndof, niodof)
    ...
    use calcdisplace_mod, only : calcdisplace,GCDblocksize
...
!DBG       print*,'rindex blocksize=',blocksize
...
call alloc_print_usage(iosystem%comp_comm,80,'l2629')
          ...
          call CheckMPIReturn(subName,ierror)
call alloc_print_usage(iosystem%comp_comm,80,'l2635')
...
call alloc_print_usage(iosystem%comp_comm,80,'l1447in')
    pos = 1
    do i=1,num_iotasks
...
!DBG       print*,'sindex blocksize=',blocksize

       len = scount(i)/blocksize        
       allocate(displace(len))
!DBG       print *,'allocate(displace(len)): len:',len
