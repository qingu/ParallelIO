...
#ifdef TIMING
!pw    call t_startf("pio_write_darray")
!pw++
!pw call t_adj_detailf(-2)
    call t_startf("pio_write_darray_bin")
!pw--
#endif
    ! -----------------------------------------------------
    ! pull information from file_desc_t data structure
    ...
    !-----------------------------------------
#ifdef TIMING
!pw    call t_startf("pio_rearrange_write")
!pw++
    call t_startf("pio_rearrange_write_bin")
!pw--
#endif
    if(UseRearranger) then 
       !------------------------------------
...
#ifdef TIMING
!pw    call t_stopf("pio_rearrange_write")
!pw++
    call t_stopf("pio_rearrange_write_bin")
!pw--
#endif
    ...
    !EOC
#ifdef TIMING
!pw    call t_stopf("pio_write_darray")
!pw++
    call t_stopf("pio_write_darray_bin")
!pw call t_adj_detailf(+2)
!pw--
#endif
# 853 "piodarray.F90.in"
...
#ifdef TIMING
!pw    call t_startf("pio_read_darray")
!pw++
    call t_adj_detailf(-2)
    call t_startf("pio_read_darray_bin")
!pw--
#endif
...
#ifdef TIMING
!pw    call t_startf("pio_rearrange_read")
!pw++
    call t_startf("pio_rearrange_read_bin")
!pw--
#endif
    if(UseRearranger) then 
       !------------------------------------
...
#ifdef TIMING
!pw    call t_stopf("pio_rearrange_read")
!pw++
    call t_stopf("pio_rearrange_read_bin")
!pw--
#endif
    ...
    !EOC
#ifdef TIMING
!pw    call t_stopf("pio_read_darray")
!pw++
    call t_stopf("pio_read_darray_bin")
    call t_adj_detailf(+2)
!pw--
#endif

# 1230 "piodarray.F90.in"
...
#endif
# 1346 "piodarray.F90.in"
  end subroutine darray_write_complete
    

#ifdef _COMPRESSION

# 1351 "piodarray.F90.in"
...
#endif
# 1461 "piodarray.F90.in"
  end subroutine write_vdc2_real

# 1463 "piodarray.F90.in"
