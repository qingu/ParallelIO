...
!===================================================
#define __PIO_FILE__ "piodarray.F90.in"
...
#endif
  private
  public :: pio_read_darray, pio_write_darray, darray_write_complete
...
#else
       array_of_requests => File%requests
#endif

       print *,__FILE__,__LINE__, array_of_requests, cnt, file%request_cnt
#ifdef _PNETCDF
