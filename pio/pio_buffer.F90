...
# 99 "pio_buffer.F90.in"
  subroutine pio_buffer_flush(File)
    ...
    deallocate(status)
    file%request_cnt=0
    file%requests=MPI_REQUEST_NULL
...
#endif
#endif
    bufsize = bufsize+int(addsize,kind=pio_offset)
