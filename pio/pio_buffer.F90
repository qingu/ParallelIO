!===================================================
! DO NOT EDIT THIS FILE, it was generated using /scratch/scratchdirs/jedwards/testpio.norsend/src/pio/genf90.pl 
...
!! @private
!<
# 24 "pio_buffer.F90.in"
  interface pio_buffer_add_data
! TYPE real,int,double
     module procedure pio_buffer_add_data_real
! TYPE real,int,double
     module procedure pio_buffer_add_data_int
! TYPE real,int,double
     module procedure pio_buffer_add_data_double
  end interface
...
# 52 "pio_buffer.F90.in"
contains

# 54 "pio_buffer.F90.in"
...
! TYPE real,int,double  
# 207 "pio_buffer.F90.in"
  subroutine pio_buffer_add_data_real (File, IOBUF)
...
#endif
  end subroutine pio_buffer_add_data_real

! TYPE real,int,double  
# 207 "pio_buffer.F90.in"
  subroutine pio_buffer_add_data_int (File, IOBUF)
    use pio_kinds, only : r4, r8, i4
    use pio_types, only : io_data_list
    type(file_desc_t) :: File
...
#endif
  end subroutine pio_buffer_add_data_int

! TYPE real,int,double  
# 207 "pio_buffer.F90.in"
  subroutine pio_buffer_add_data_double (File, IOBUF)
    use pio_kinds, only : r4, r8, i4
    use pio_types, only : io_data_list
    type(file_desc_t) :: File
...
#endif
  end subroutine pio_buffer_add_data_double
#endif
