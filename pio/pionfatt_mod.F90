...
!! @file 
!! $Revision: 835 $
!! $LastChangedDate: 2013-09-26 14:20:29 -0600 (Thu, 26 Sep 2013) $
...
module pionfatt_mod
  ...
  use pio_timeseries, only : check_if_timeseries_file
...
#undef DEBUG
    ...
    if(Debug .or. ierr /= PIO_NOERR) print *,__FILE__,__LINE__,varid,trim(name)
...
# 273 "pionfatt_mod.F90.in"
  integer function put_att_desc_text (File,varDesc,name,value) result(ierr)
    ...
    type (File_desc_t), pointer :: LFile
    ...
    if(check_if_timeseries_file(File)) then
       if(allocated(vardesc%tsvarfile)) then
          LFile => vardesc%tsvarfile
          print *,__FILE__,__LINE__,name,vardesc%name
       endif
    endif
    ierr = put_att_text (LFile,varDesc%varid,name,value)
...
# 273 "pionfatt_mod.F90.in"
  integer function put_att_desc_real (File,varDesc,name,value) result(ierr)
    ...
    ierr = put_att_real (LFile,varDesc%varid,name,value)
...
# 273 "pionfatt_mod.F90.in"
  integer function put_att_desc_double (File,varDesc,name,value) result(ierr)
    ...
    ierr = put_att_double (LFile,varDesc%varid,name,value)
...
# 273 "pionfatt_mod.F90.in"
  integer function put_att_desc_int (File,varDesc,name,value) result(ierr)
    ...
    ierr = put_att_int (LFile,varDesc%varid,name,value)
...
# 306 "pionfatt_mod.F90.in"
  integer function put_att_desc_1d_real (File,varDesc,name,value) result(ierr)
    ...
    ierr = put_att_1d_real (LFile,varDesc%varid,name,value)
...
# 306 "pionfatt_mod.F90.in"
  integer function put_att_desc_1d_int (File,varDesc,name,value) result(ierr)
    ...
    ierr = put_att_1d_int (LFile,varDesc%varid,name,value)
...
# 306 "pionfatt_mod.F90.in"
  integer function put_att_desc_1d_double (File,varDesc,name,value) result(ierr)
    ...
    ierr = put_att_1d_double (LFile,varDesc%varid,name,value)
...
# 366 "pionfatt_mod.F90.in"
  integer function get_att_desc_1d_real (File,varDesc,name,value) result(ierr)
    ...
    ierr = get_att_1d_real (LFile,varDesc%varid,name,value)
...
# 366 "pionfatt_mod.F90.in"
  integer function get_att_desc_1d_int (File,varDesc,name,value) result(ierr)
    ...
    ierr = get_att_1d_int (LFile,varDesc%varid,name,value)
...
# 366 "pionfatt_mod.F90.in"
  integer function get_att_desc_1d_double (File,varDesc,name,value) result(ierr)
    ...
    ierr = get_att_1d_double (LFile,varDesc%varid,name,value)
