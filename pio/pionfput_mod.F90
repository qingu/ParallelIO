...
#ifdef _PNETCDF
       case(pio_iotype_pnetcdf)
#if defined (USE_INDEP_MODE) || defined (USE_BLOCKING_WRITE) 
          ierr = nfmpi_begin_indep_data(File%fh)
          if(Ios%io_rank==0 .and. (ierr==NF_EINDEP .or. ierr==PIO_NOERR)) then
